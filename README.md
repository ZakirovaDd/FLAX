...
```
Получаем большой файл в котором нас интересуют только столбцы 1 (название хромомсомы), 4 (номер образца), 7(ген), 13(имя)
```
...
Для анализа обогащенности использовалась библиотека xEnricherYours, пакета XGR (https://xgr.r-forge.r-project.org/)
